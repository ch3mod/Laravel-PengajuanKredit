...
<head>
    ...
    <style>
        ...
        .marquee-container {
            overflow: hidden;
            /* Menyembunyikan teks di luar batas */
            width: 100%;
        ...
        .sidebar-container {
            ...
            height: 100%;
            /* Memastikan sidebar memenuhi tinggi layar */
        }

        /* Membuat navigasi sidebar fleksibel */
        .sidebar-nav {
            flex-grow: 1;
            /* Navigasi akan tumbuh memenuhi ruang yang tersedia */
        }
        ...
        @media print {
            body {
                ...
                /* Agar warna tetap ada saat dicetak */
                    ...
                    'copy', 'csv', 'excel',
                    {
                        ...
                        customize: function(win) {
                            $(win.document.body).find('table')
                                .addClass('compact') // Biar lebih rapat
                                .css('font-size', '10px'); // Ukuran font kecil

                            $(win.document.body).find('table th')
                                .css('background-color', '#007bff') // Warna header
                                .css('color', 'white');

                            $(win.document.body).find('table tr:nth-child(even)')
                                .css('background-color', '#f2f2f2'); // Warna baris genap
                        }
                    }
                ],
