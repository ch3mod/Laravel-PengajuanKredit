                    ...
                    <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                        ...
                        {{-- <li class="nav-item dropdown bi-checking-container">
                            @if (Route::is('pengajuan.dashboard'))
                                <a class="nav-link dropdown-toggle" href="#" id="biCheckingDropdown"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="{{ asset('assets/images/logos/bi-logo.png') }}" alt="Logo BI"
                                        class="bi-logo">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="biCheckingDropdown">
                                    <li class="dropdown-item">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="biChecking"
                                                id="biCheckingYes" value="yes"
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item d-none d-xl-block">
                    <a href="{{ route('dashboard') }}" class="text-nowrap nav-link">
                        <img src="{{ asset('assets/images/logos/bank_kerta.svg') }}" class="dark-logo"
                            width="180" alt="modernize-img" />
                        <img src="{{ asset('assets/images/logos/bank_kerta.svg') }}" class="light-logo"
                            width="180" alt="modernize-img" />
                    </a>
                </li>
            </ul>
