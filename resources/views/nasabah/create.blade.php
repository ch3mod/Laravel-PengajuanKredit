        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('nasabah.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="description" class="form-label">BI Checking</label>
                        <select name="bi_checking" class="form-control @error('bi_checking') is-invalid @enderror" required>
                            <option value="">Pilih Status</option>
                            <option value="Lancar">Lancar</option>
                            <option value="Dalam Pengawasan Khusus">Dalam Pengawasan Khusus</option>
