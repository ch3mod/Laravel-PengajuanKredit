...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/laporan', [LaporanController::class, 'index'])->name('laporan.nasabah');
    Route::get('/laporan/cetak', [LaporanController::class, 'cetakNasabah'])->name('laporan.cetak');
    Route::get('/laporan/cetak/single/{id}', [LaporanController::class, 'cetakSingleNasabah'])->name('laporan.cetak-single');
